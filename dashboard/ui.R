...
relationships_tab <- tabItem(
  ...
  fluidRow(
    box(
      ...
      column(12, sliderInput("cd_range", "Competition Density", min = 0, max = 1, value = c(0.2, 0.5))),
...
star_tab <- tabItem(
  ...
  fluidRow(
    box(
      title = "Customizations", width = 12, solidHeader = TRUE, status = "primary", collapsible = TRUE,
      column(4, date_range_widget("star_date_range")),
      column(4, cow_selection_widget("star_cow_selection", multiple = FALSE)),
      column(8, sliderInput("star_cd_range", "Competition Density", min = 0, max = 1, value = c(0.2, 0.5))),
