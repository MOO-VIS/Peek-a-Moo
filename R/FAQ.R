#' Calls the 'methodologies' written section for the FAQ into ui.R
#'
#'
...
#' Calls the 'about' written section for the FAQ into ui.R
#'
#'
about_FAQ <- function() {
  fluidRow(
    h2(paste0("About")),
    tags$p(
      "Guided by Borbala Foris and Sky Cheng, researchers with the UBC Animal Welfare Program, this dashboard was created as part of a capstone project for the ",
...
#' Calls the 'data' written section for the FAQ into ui.R
#'
#'
data_FAQ <- function() {
  fluidRow(
    h2(paste0("Data")),
    tags$p(
      "The data presented in this dashboard was collected at the ",
    ...
    tags$p(
      "The data was collected using various Instantec and HOBO smart technology within the barn. For more information on the data, its collection, and usage expectations, please contact the ",
      tags$a("Animal Welfare Department at UBC.", href = "mailto:animal.welfare@ubc.ca")
    )
  )
}

#' Calls the 'statistical analysis' written section for the FAQ into ui.R
#'
#'
statistical_FAQ <- function() {
  fluidRow(
    ...
    tags$p(
      "The full statistical analysis and code can also be viewed within its separate repo ",
      tags$a("here.",
